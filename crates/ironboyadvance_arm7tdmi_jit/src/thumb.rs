...
impl Compile for ThumbInstruction {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
        match self {
            Self::MoveShiftedRegister(i) => i.compile(cpu),
            Self::AddSubtract(i) => i.compile(cpu),
            Self::MoveCompareAddSubtractImmediate(i) => i.compile(cpu),
            Self::AluOperations(i) => i.compile(cpu),
            Self::HiRegisterOperationsBranchExchange(i) => i.compile(cpu),
            Self::PcRelativeLoad(i) => i.compile(cpu),
            Self::LoadStoreRegisterOffset(i) => i.compile(cpu),
            Self::LoadStoreSignExtendedByteHalfword(i) => i.compile(cpu),
            Self::LoadStoreImmediateOffset(i) => i.compile(cpu),
            Self::LoadStoreHalfword(i) => i.compile(cpu),
            Self::SpRelativeLoadStore(i) => i.compile(cpu),
            Self::LoadAddress(i) => i.compile(cpu),
            Self::AddOffsetToSp(i) => i.compile(cpu),
            Self::PushPopRegisters(i) => i.compile(cpu),
            Self::MultipleLoadStore(i) => i.compile(cpu),
            Self::ConditionalBranch(i) => i.compile(cpu),
            Self::SoftwareInterrupt(i) => i.compile(cpu),
            Self::UnconditionalBranch(i) => i.compile(cpu),
            Self::LongBranchWithLink(i) => i.compile(cpu),
...
impl Compile for AddOffsetToSp {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for AluOperations {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for ConditionalBranch {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for HiRegisterOperationsBranchExchange {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for LoadStoreHalfword {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for LoadStoreImmediateOffset {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for LoadStoreRegisterOffset {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for LoadStoreSignExtendedByteHalfword {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
        let ro_value = cpu.register(self.ro() as usize);
        let rb_value = cpu.register(self.rb() as usize);
        let address = rb_value.wrapping_add(ro_value);
...
impl Compile for LongBranchWithLink {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
        match self.high() {
            true => {
...
impl Compile for MoveCompareAddSubtractImmediate {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for MoveShiftedRegister {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
        let rd = self.rd() as usize;
...
impl Compile for MultipleLoadStore {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for PcRelativeLoad {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
        let offset = self.offset();
...
impl Compile for PushPopRegisters {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for SpRelativeLoadStore {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
...
impl Compile for UnconditionalBranch {
    fn compile<I: MemoryInterface>(&self, cpu: &mut Arm7tdmiCpu<I>) -> CpuAction {
