...
impl Compile for ThumbInstruction {
    fn compile(&self, assembler: &mut VecAssembler<Aarch64Relocation>) {
        match self {
            Self::MoveShiftedRegister(i) => todo!(),
            Self::AddSubtract(i) => todo!(),
            Self::MoveCompareAddSubtractImmediate(i) => todo!(),
            Self::AluOperations(i) => todo!(),
            Self::HiRegisterOperationsBranchExchange(i) => todo!(),
            Self::PcRelativeLoad(i) => todo!(),
            Self::LoadStoreRegisterOffset(i) => todo!(),
            Self::LoadStoreSignExtendedByteHalfword(i) => todo!(),
            Self::LoadStoreImmediateOffset(i) => todo!(),
            Self::LoadStoreHalfword(i) => todo!(),
            Self::SpRelativeLoadStore(i) => todo!(),
            Self::LoadAddress(i) => todo!(),
            Self::AddOffsetToSp(i) => todo!(),
            Self::PushPopRegisters(i) => todo!(),
            Self::MultipleLoadStore(i) => todo!(),
            Self::ConditionalBranch(i) => todo!(),
            Self::SoftwareInterrupt(i) => todo!(),
            Self::UnconditionalBranch(i) => todo!(),
            Self::LongBranchWithLink(i) => todo!(),
            Self::Undefined(i) => todo!(),
        }
    }
}
