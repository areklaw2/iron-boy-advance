use crate::Compile;
use dynasmrt::{VecAssembler, aarch64::Aarch64Relocation, dynasm};
...
impl Compile for ArmInstruction {
    fn compile(&self, assembler: &mut VecAssembler<Aarch64Relocation>) {
        match self {
            Self::DataProcessing(i) => todo!(),
            Self::PsrTransfer(i) => todo!(),
            Self::Multiply(i) => todo!(),
            Self::MultiplyLong(i) => todo!(),
            Self::SingleDataSwap(i) => todo!(),
            Self::BranchAndExchange(i) => todo!(),
            Self::HalfwordAndSignedDataTransfer(i) => todo!(),
            Self::SingleDataTransfer(i) => todo!(),
            Self::Undefined(i) => todo!(),
            Self::BlockDataTransfer(i) => todo!(),
            Self::BranchAndBranchWithLink(i) => i.compile(assembler),
            Self::SoftwareInterrupt(i) => todo!(),
            Self::CoprocessorDataOperation(i) => todo!(),
            Self::CoprocessorDataTransfer(i) => todo!(),
            Self::CoprocessorRegisterTransfer(i) => todo!(),
        }
    }
}
