...
pub fn render_mode3(ctx: &ScanlineContext, bg_line: &mut [Option<u16>; VIEWPORT_WIDTH]) {
...
pub fn render_mode4(ctx: &ScanlineContext, bg_line: &mut [Option<u16>; VIEWPORT_WIDTH]) {
...
pub fn render_mode5(ctx: &ScanlineContext, bg_line: &mut [Option<u16>; VIEWPORT_WIDTH]) {
